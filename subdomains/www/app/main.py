...
import requests
from app.projects import (ai_project, blog_project, dnd_project,
                          squash_the_creeps_project)
...
projects = [
    ...
    ai_project.project,
    squash_the_creeps_project.project,
    dnd_project.project,
]
routers = [
    blog_project.router,
    ai_project.router,
    squash_the_creeps_project.router,
    dnd_project.router,
]
...
async def cypress(request: Request, keyframe):
    ...
    print(img_path)
    return templates.TemplateResponse(
        "htmx_partials/cypress_animation.html",
        {"request": request, "img_path": img_path, "keyframe": keyframe},
    )
